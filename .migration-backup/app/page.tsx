        ...
        <div className="mx-auto w-full max-w-5xl px-6 py-14">
            ...
            <section className="py-14 border-t border-border">
              <div className="text-center mb-8">
                <h3 className="text-lg font-semibold text-foreground mb-4">Halaman Lainnya</h3>
                <div className="flex flex-wrap justify-center gap-3 text-xs">
                  <a href="/hlr-lookup" className="font-medium text-primary hover:underline">HLR Lookup Gratis</a>
                  <span className="text-border">•</span>
                  <a href="/tracker-premium" className="font-medium text-primary hover:underline">Tracker Premium</a>
                  <span className="text-border">•</span>
                  <a href="/tentang-kami" className="font-medium text-primary hover:underline">Tentang Kami</a>
                </div>
                <div className="flex flex-wrap justify-center gap-3 text-xs mt-3">
                  <a href="/kebijakan-privasi" className="font-medium text-primary hover:underline">Kebijakan Privasi</a>
                  <span className="text-border">•</span>
                  <a href="/syarat-layanan" className="font-medium text-primary hover:underline">Syarat Layanan</a>
                  <span className="text-border">•</span>
                  <a href="/disclaimer" className="font-medium text-primary hover:underline">Disclaimer</a>
                </div>
              </div>
            </section>
          </div>
