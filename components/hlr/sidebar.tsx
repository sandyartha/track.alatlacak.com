...
const menuItems = [
  { id: "about", label: "Tentang", icon: MessageSquare, href: "/#about" },
  { id: "services", label: "Layanan", icon: Zap, href: "/#services" },
  { id: "device", label: "Device", icon: Navigation, href: "/#device" },
  { id: "faq", label: "FAQ", icon: MessageSquare, href: "/#faq" },
]
